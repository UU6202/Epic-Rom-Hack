...
MMC3_DISABLE_IRQ = $e000

.macro SELECT_ROM bank
  lda #%00000110 ; Select the bank at $8000-$9FFF
  sta MMC3_BANK_SELECT
  lda #bank
  sta MMC3_BANK_VALUE ; Write the new value to it
.endmacro

.macro SELECT_RAM
  ; Do nothing, MMC3 has RAM visible all the time
.endmacro
